...
import { Users, Mail, Calendar, BookOpen, TrendingUp, Phone, MapPin, MessageSquare, Plus, Edit, Trash2, Star, Video, Image as ImageIcon, Type, Check, X } from 'lucide-react';
            ...
            <div className="flex space-x-4">
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium ${
                  filter === 'all' ? 'bg-primary-100 text-primary-700' : 'text-gray-600 hover:text-gray-900'
                }`}
              >
                All ({stats.total})
              </button>
